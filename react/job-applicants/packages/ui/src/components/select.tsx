...
function SelectItem({
  className,
  children,
  // allow callers to hide the selected-item indicator when needed (e.g., LanguageSwitcher)
  hideIndicator,
  ...props
  ...
  return (
    ...
    >
      ...
      >
        {/* render the check icon unless caller requested it hidden */}
        {!hideIndicator ? <CheckIcon className="pointer-events-none" /> : null}
      </SelectPrimitive.ItemIndicator>
    </SelectPrimitive.Item>
  )
}
